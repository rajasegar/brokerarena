$(function(){
	...
	$('#btnUpdateBranch').click(function() {
		...
		{ 
			...
			data: {'txtOwnBranches':$('#txtOwnBranches').val(),'txtFranchiseeBranches':$('#txtFranchiseeBranches').val()},
			success: 
				function(t) 
				{ 
					$("div#info").empty()
