...
if(isset($_SESSION['user']))
{
	...
	$broker = $userTools->getBroker($user->m_BrokerID);
	$broker->loadParams();
	//print_r($user->m_ExchSgmtParams);
}
?>
	    ...
	    <div class="row">
			<div class="span9">
				<div class="row">
					...
					<div class="span7">
						<h1>Brokers' Parameters</h1>
			
			<div id="myTab" class="tabbable tabs-left well">
				<ul class="nav nav-tabs">
					<li class="active"><a href="#0" data-toggle="tab"><span>Exchange Segment Memberships</span></a></li>
					<li><a href="#1" data-toggle="tab"><span>Products</span></a></li>
					<li><a href="#2" data-toggle="tab"><span>Branches</span></a></li>
					<li><a href="#3" data-toggle="tab"><span>Account Opening Mode</span></a></li>
					<li><a href="#4" data-toggle="tab"><span>Risk Management</span></a></li>
					<li><a href="#5" data-toggle="tab"><span>Security</span></a></li>
					<li><a href="#6" data-toggle="tab"><span>Services</span></a></li>
					<li><a href="#7" data-toggle="tab"><span>Value Added Services</span></a></li>
					<li><a href="#8" data-toggle="tab"><span>Customer Service</span></a></li>
					<li><a href="#9" data-toggle="tab"><span>Awards</span></a></li>
				...
				<div id="0" class="tab-pane active">
					...
					<input type="button" name="btnUpdateExchSgmnts" id="btnUpdateExchSgmnts" value="Update" class="btn btn-primary" />
				</div>
				<div id="1" class="tab-pane">
					...
					<input type="button" name="btnUpdateProducts" id="btnUpdateProducts" value="Update" class="btn btn-primary" />
				</div>
				<div id="2" class="tab-pane">
					<table>
						...
						<input type="button" name="btnUpdateBranch" id="btnUpdateBranch" value="Update" class="btn btn-primary" />
						</td></tr>
					</table>
				</div>
				<div id="3" class="tab-pane">
					...
					<input type="button" name="btnUpdateAcctOpenModes" id="btnUpdateAcctOpenModes" value="Update" class="btn btn-primary" />
				</div>
				<div id="4" class="tab-pane">
					...
					<input type="button" name="btnUpdateRMS" id="btnUpdateRMS" value="Update" class="btn btn-primary" />
				</div>
				<div id="5" class="tab-pane">
					...
					<input type="button" name="btnUpdateSecurity" id="btnUpdateSecurity" value="Update" class="btn btn-primary" />
				</div>
				<div id="6" class="tab-pane">
					<table>
					<tr><td><input type="checkbox" name="chkServices"  value="1" <?php echo ($broker->m_ServiceParams['bMTMLimit'] == 1) ? "checked" : "" ;?>/></td><td>Offline Account</td></tr>
					<tr><td colspan="2">
					<fieldset>
					...
					<input type="button" name="btnUpdateServices" id="btnUpdateServices" value="Update" class="btn btn-primary" />
				</div>
				<div id="7" class="tab-pane">
					...
					<input type="button" name="btnUpdateVAS" id="btnUpdateVAS" value="Update" class="btn btn-primary" />
				</div>
				<div id="8" class="tab-pane">
					...
					<input type="button" name="btnUpdateCustomerService" id="btnUpdateCustomerService" value="Update" class="btn btn-primary" />
				</div>
				<div id="9" class="tab-pane">
					...
					<input type="button" name="btnUpdateAwards" id="btnUpdateAwards" value="Update" class="btn btn-primary" />
				</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtAcctOpening" id="txtAcctOpening" value="<?php echo $broker->m_Charges['acct_opening'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtAMCAnnual" id="txtAMCAnnual" value="<?php echo $broker->m_Charges['amc_annual'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtAMCMonthly" id="txtAMCMonthly" value="<?php echo $broker->m_Charges['amc_monthly'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtOtherService" id="txtOtherService" value="<?php echo $broker->m_Charges['other_service'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtEXETrading" id="txtEXETrading" value="<?php echo $broker->m_Charges['exe_trading'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtBrowserTrading" id="txtBrowserTrading" value="<?php echo $broker->m_Charges['browser_trading'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtMobileTrading" id="txtMobileTrading" value="<?php echo $broker->m_Charges['mobile_trading'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtCallnTrade" id="txtCallnTrade" value="<?php echo $broker->m_Charges['call_n_trade'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtAccountClosure" id="txtAccountClosure" value="<?php echo $broker->m_Charges['account_closure'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtProgramTrading" id="txtProgramTrading" value="<?php echo $broker->m_Charges['program_trading'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtFutureTrading" id="txtFutureTrading" value="<?php echo $broker->m_Charges['future_trading'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtOptions" id="txtOptions" value="<?php echo $broker->m_Charges['options'];?>">	
										</div>
									</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<div class="input-prepend">
											<input type="text" name="txtMinBrokerage" id="txtMinBrokerage" value="<?php echo $broker->m_Charges['min_brokerage'];?>">	
										</div>
									</div>
								</div>
...
<script type="text/javascript" src="assets/js/update_params.js"></script>
